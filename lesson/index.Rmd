...
p <- ggplot(data = mpg, aes(x =displ,  y= hwy ))
p + geom_point(aes(shape = factor(cyl)), alpha = .3) +
...
p_diamonds <- ggplot(data_work, aes(x = carat, y = price)) + 
  geom_point(aes(shape = cut), alpha = 0.1) #Says to ggplot2, give one shape to each modality of cut
p_diamonds
```
...
* [https://cedricscherer.netlify.app/2019/08/05/a-ggplot2-tutorial-for-beautiful-plotting-in-r/](wonderful and complete article about ggplot): my holy bible for ggplot2
* [https://ggplot2tutor.com/](a bunch of tutorials) on ggplot2, really clear
* [https://ggplot2-book.org/](the ggplot2 book), recall and explanations
...
* [http://www.nathalievialaneix.eu/doc/html/biostat-ggplot2.html#/](a lesson from N. Vialaneix)
* [https://ggplot2-book.org/](the ggplot2 book)
* [https://github.com/abichat/tidytuesday](wonderful plots of A. Bichat): go take a look !
...
Lesson contents available at: [https://github.com/RemiMahmoud/data_wrangling](https://github.com/RemiMahmoud/ggplot2_lesson)
